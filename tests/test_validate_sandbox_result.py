...
def test_valid_sandbox_result_native_json_pass() -> None:
    ...
    checked = next(result for result in data["results"] if result["code"] == "sandbox_result_checked")
...
def test_invalid_sandbox_result_native_json_fail() -> None:
...
def test_sandbox_result_shaped_json_with_invalid_schema_is_detected_and_fails(tmp_path: Path) -> None:
...
def test_sandbox_result_shaped_json_with_missing_schema_is_detected_and_fails(tmp_path: Path) -> None:
...
def test_unrelated_json_is_not_sandbox_result() -> None:
