...
import { validateEnvCommand } from './commands/validate-env';
...
const cli = yargs(hideBin(process.argv))
  ...
  // mcp validate-env command
  .command(
    'validate-env',
    'Validate AI OS environment (paths, permissions, encoding, locks)',
    (yargsBuilder: any) => {
      return yargsBuilder;
    },
    validateEnvCommand as any
  )
