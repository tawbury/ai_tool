---
name: Developer DevOps Unified
type: skill
id: SKILL-DEV-DEVOPS-UNIFIED-v1
version: 2.2.0
updated: 2026-04-14
scope: developer
used_by: [developer]
...
| Mode | Keywords |
|------|----------|
| MONITORING | monitoring, logging, alerting, dashboard, metrics |
| SERVERLESS | serverless, lambda, function, event, faas |
| AUTOSCALING | autoscaling, scaling, elastic, load, capacity |
| SERVERLESS | serverless, lambda, function, event, faas |
| AUTOSCALING | autoscaling, scaling, elastic, load, capacity |
...
**Purpose**: Physical isolation of application development in DevOps
