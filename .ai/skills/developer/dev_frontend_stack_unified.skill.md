---
name: Developer Frontend Stack Unified
type: skill
id: SKILL-DEV-FRONTEND-STACK-UNIFIED-v1
version: 2.2.0
updated: 2026-04-14
scope: developer
used_by: [developer]
...
| Mode | Keywords |
|------|----------|
| BASIC_FRONTEND | basic, html, css, vanilla, simple |
| REACT_SPECIALIZATION | react, component, jsx, hooks |
| STATE_MANAGEMENT | state, redux, zustand, context, store |
| BUILD_TOOLS | build, webpack, vite, bundle, optimize |
| REACT_SPECIALIZATION | react, component, jsx, hooks |
| STATE_MANAGEMENT | state, redux, zustand, context, store |
| BUILD_TOOLS | build, webpack, vite, bundle, optimize |
...
**Purpose**: Physical isolation of technology conflicts in frontend development
...
- **Asset path management** (relative paths, no absolute URLs)
- **Environment-specific configuration** (API endpoints, build variables)
- **Hard coding prevention** (no hardcoded URLs, API keys, or paths)
<!-- END_BLOCK -->
