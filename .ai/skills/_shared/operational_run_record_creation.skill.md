---
name: Operational Run Record Creation
type: skill
id: SKILL-OPS-RUNRECORD-v1
version: 2.2.0
updated: 2026-04-14
scope: shared
used_by: [hr, pm, developer, contents-creator, finance]
...
### Required Inputs
- **Run Record Template**: Reference to `.ai/templates/run_record_template.md` or equivalent
...
3. **Create Run Record File** - Use `.ai/templates/run_record_template.md` as base, name with date/descriptor: `run_record_YYYYMMDD_<short_slug>.md`
...
Note: Project-specific folder rules take precedence if they exist.
