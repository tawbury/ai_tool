---
name: Operational Roadmap Management
type: skill
id: SKILL-OPS-ROADMAP-v1
version: 2.2.0
updated: 2026-04-14
scope: shared
...
### Required Inputs
- **Roadmap Template**: Reference to `.ai/templates/roadmap_template.md` or equivalent
...
2. **Locate or Create Roadmap File** - If creating new, use `.ai/templates/roadmap_template.md` as base; if updating, open existing Roadmap
