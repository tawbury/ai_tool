...
|-------|------|---------|---------|
| Strategic Planning | strategic_planning.skill.md | Vision definition, goal setting | PM, Senior Agents |
| Requirements Analysis | requirements_analysis.skill.md | Requirement gathering and analysis | PM, Developer |
| System Design | system_design.skill.md | Architecture and system design | Developer, Architect |
| Execution Planning | execution_planning.skill.md | Task and project execution planning | All Agents |
| Decision Analysis | decision_analysis.skill.md | Decision making and analysis | All Agents |

### Operational Skills
| Skill | File | Purpose | Used By |
|-------|------|---------|---------|
| Roadmap Management | operational_roadmap_management.skill.md | Roadmap creation and management | All Agents |
| Run Record Creation | operational_run_record_creation.skill.md | Execution evidence documentation | All Agents |

### Framework Skills
| Skill | File | Modes | Agents |
|-------|------|-------|--------|
