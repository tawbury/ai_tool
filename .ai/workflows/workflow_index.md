...
**File**: [[code_quality_validation.workflow.md]]
**ID**: WF-CODEQUALITY-001

| Stage | Responsible | Skills | Tools |
|-------|-------------|--------|-------|
| 1. Pre-Commit Validation | Developer | - | test_hard_coding_examples.py |
| 2. Automated Quality Analysis | Developer | code_quality_and_technical_debt_analysis | - |
| 3. Code Review Integration | Developer | dev_code_review | - |
| 4. Backend/Frontend Validation | Developer | dev_backend, dev_frontend_stack_unified | - |
| 5. Improvement Recommendations | Developer | - | improvement_template |
| 6. Re-validation and Approval | Senior Developer | - | - |
...
**File**: [[deploy_automation.workflow.md]]
**ID**: WF-DEPLOY-001

| Stage | Responsible | Template |
|-------|-------------|----------|
| 1. Planning/Strategy | PM + Developer | prd_template |
| 2. Design/Architecture | Developer | architecture_template |
| 3. Specification | Developer | spec_template |
| 4. Decision Making | Developer + PM | decision_template |
| 5. Local Development & Primary Testing | Developer | run_record_template |
| 6. Container Build & Rehearsal Testing | Developer | run_record_template |
| 7. Server Deployment & Runtime Validation | Developer + Ops | run_record_template |

**Primary Agent**: Developer
**Supporting**: PM, Ops (for deployment)
**Focus**: Automated deployment pipeline with server immutability and rollback capabilities
**Note**: Local-fix loop only - server is read-only execution environment, all code changes happen locally
**Operational Loop**: Roadmap tracks deployment phases, Tasks define deployment units, Run Records document deployment progress and issues
