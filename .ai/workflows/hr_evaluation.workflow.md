...
- **Cross-Agent Assessment**: HR uses shared skills for consistent evaluation across all agents
- **Skill Mapping**: Uses Agent Skill Mapping table from HR Agent for standardized assessment
...
- `.ai/skills/_shared/strategic_planning.skill.md` - Strategic planning
- `.ai/skills/_shared/requirements_analysis.skill.md` - Requirements analysis
- `.ai/skills/_shared/system_design.skill.md` - System design (for technical roles)
- `.ai/templates/_base/base_mapping.md` - Agent-skill mapping reference
