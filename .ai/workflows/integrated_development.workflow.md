...
### Skills
- `.ai/skills/_shared/system_design.skill.md` - System architecture
- `.ai/skills/_shared/requirements_analysis.skill.md` - Requirements analysis
- `.ai/skills/_shared/decision_analysis.skill.md` - Technical decisions
- `.ai/skills/developer/` - Development specific skills
- `.ai/skills/pm/` - PM domain-specific skills
- `.ai/skills/finance/` - Finance specific skills
- `.ai/skills/contents-creator/` - Contents creation specific skills
