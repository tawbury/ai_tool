# Meta
- Document Type: Data Pipeline Specification
- Document ID: DATA-PIPELINE-[PROJECT]-[NUMBER]
- Title: [Project Name] Data Pipeline Specification
...
- Tags: data-pipeline, specification, development
