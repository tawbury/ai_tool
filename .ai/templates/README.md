...
- **Meta Section**: Standardized meta fields (Document Type, Document ID, Title, Status, Created, Updated, Author, Reviewer, Parent Document, Related Reference, Version, Tags)
...
- **ARCHITECTURE**: `ARCHITECTURE-[PROJECT]-[NUMBER]` (예: ARCHITECTURE-TRADING-001)
- **BACKTEST**: `BACKTEST-[PROJECT]-[NUMBER]` (예: BACKTEST-STRATEGY-001)
- **DATA-PIPELINE**: `DATA-PIPELINE-[PROJECT]-[NUMBER]` (예: DATA-PIPELINE-AI_TOOL-001)
- **DECISION**: `DECISION-[TOPIC]-[NUMBER]` (예: DECISION-ARCHITECTURE-001)
- **PRD**: `PRD-[PROJECT]-[NUMBER]` (예: PRD-TRADING-001)
- **REPORT**: `REPORT-[PROJECT]-[YYYYMMDD]-[SEQUENCE]` (예: REPORT-HR-20260126-1)
- **RISK**: `RISK-[PROJECT]-[NUMBER]` (예: RISK-TRADING-001)
- **ROADMAP**: `ROADMAP-[PROJECT]-[NUMBER]` (예: ROADMAP-AI_TOOL-001)
- **RUN**: `RUN-[PROJECT]-[YYYYMMDD]-[SEQUENCE]` (예: RUN-AI_TOOL-20260126-1)
- **SPEC**: `SPEC-[PROJECT]-[NUMBER]` (예: SPEC-API-001)
- **STRATEGY**: `STRATEGY-[PROJECT]-[NUMBER]` (예: STRATEGY-TRADING-001)
- **TASK**: `TASK-[CATEGORY]-[YYYYMMDD]-[HHMM]` (예: TASK-BACKEND-20260126-1917)
- **WF**: `WF-[CATEGORY]-[NUMBER]` (예: WF-TRADING-001)
...
- **Meta Section**: Must include all required fields following the standardized format from base_template.md
- **Contents Sections**: Must use proper header format (##)
- **Separator**: Must use `---` between meta and contents

### Quality Assurance
- **Template Validation**: Use `.ai/validators/` system for structure validation
- **Meta Integrity**: Ensure all required meta fields are present and follow the standardized format
- **Format Consistency**: Maintain standardized format across all templates
- **Document ID Compliance**: All Document IDs must follow the standardized format patterns
