...
| `docs/plan/sandbox_result_validate_output_contract_plan.md` | 8 | active implementation plan | human context | task-load | none | none | defines future `aios validate <sandbox-result.json>` native JSON/envelope v2 output contract without execution runtime |
