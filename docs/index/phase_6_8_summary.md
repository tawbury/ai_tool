...
다음 안전한 방향은 opt-in replay comparison output contract를 안정화하는 것이다.

권장 다음 작업:

1. Replay comparison native/envelope output contract stabilization tests
2. Replay comparison runtime rule promotion audit
