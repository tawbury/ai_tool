...
다음 안전한 방향은 opt-in replay comparison validation implementation을 준비하는 것이다.

권장 다음 작업:

1. `aios validate <replay-manifest.json> --replay-compare fixture` implementation bundle
2. Replay comparison native/envelope output contract tests
